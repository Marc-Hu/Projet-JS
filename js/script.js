...
$(document).ready(function() {
            ...
            $('body').on('click', '.quantite .changeQuantite', function(e) {
                    ...
                    var total = $("#totalCommande").text();
                    if ($(this).hasClass('imageMoins')) {
                        if (valeur > 1) {
                            console.log("Valeur différente de 1 donc on décrémente.");
                            valeur--;
                            total.replace(total, parseInt(total) - parseInt(prixTotal); prixTotal = prixTotal * valeur;
                            }
                            else
                            ...
                            if (valeur < 50) {
                                valeur++;
                                total.replace(total, total + prixTotal);
                        ...
                        var total = $("#totalCommande").text(total);
                    });
                ...
                $('.boutonEnre').click(function(e) {
                    ...
                    var prix = $(this).parent().find('.prixUnitaire').text();
